...
X1 <- LQ - 1.5 * (UQ - LQ)
X2 <- UQ + 1.5 * (UQ - LQ)
novershoot <- pnorm(X1, 0, 1) + (1 - pnorm(X2, 0, 1))
...
X1 <- LQ - 1.5 * (UQ - LQ)
X2 <- UQ + 1.5 * (UQ - LQ)
covershoot <- pcauchy(X1, 0, 1) + (1 - pcauchy(X2, 0, 1))
...
X1 <- LQ - 1.5 * (UQ - LQ)
X2 <- UQ + 1.5 * (UQ - LQ)
lovershoot <- plaplace(X1, 0, 1/sqrt(2)) + (1 - plaplace(X2, 0, 1/sqrt(2)))
...
X1 <- LQ - 1.5 * (UQ - LQ)
X2 <- UQ + 1.5 * (UQ - LQ)
povershoot <- ppois(X1, 10) - dpois(X1, 10) + (1 - ppois(X2, 10))
...
X1 <- LQ - 1.5 * (UQ - LQ)
X2 <- UQ + 1.5 * (UQ - LQ)
uvershoot <- punif(X1, -sqrt(3), sqrt(3)) + (1 - punif(X2, -sqrt(3), sqrt(3)))